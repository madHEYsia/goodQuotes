...
public class Success extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mContainer = inflater.inflate(R.layout.fragment_success, null);

        AdView mAdView = mContainer.findViewById(R.id.successAd);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        LinearLayout linearLayout = mContainer.findViewById(R.id.success_layout);
        constants ob = new constants();
        final String array[][] = ob.quotes;
        for (int i=870;i<983;++i){
